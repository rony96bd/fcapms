...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('project/pending', 'ProjectController@pending')->name('project.pending');
        Route::get('project/approved', 'ProjectController@approved')->name('project.approved');
        Route::get('project/banned', 'ProjectController@banned')->name('project.banned');
        Route::post('project/message', 'ProjectController@message')->name('project.message');
