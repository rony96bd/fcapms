                            ...
                            @forelse($pdata as $k => $data)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{ route('agent.frontend.manage.section', $data->id) }}" class="icon-btn btn--primary ml-1" data-toggle="tooltip" data-original-title="@lang('Edit')"><i class="la la-pen"></i></a>
    ...
    <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('agent.frontend.manage.pages.save')}}" method="POST">
                    @csrf
    ...
    <div id="removeModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('agent.frontend.manage.pages.delete') }}" method="POST">
                    @csrf
