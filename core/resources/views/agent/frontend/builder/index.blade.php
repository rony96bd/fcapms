...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('agent.frontend.manage.pages.update')}}" method="POST">
                    @csrf
...
<div class="row">
    <div class="col-md-7">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('agent.frontend.manage.section.update',$pdata->id)}}" method="post">
                    @csrf
                    ...
                    <li class="highlight icon-move clearfix">
                            ...
                            @if($secs['builder'])
                                <div class="float-right d-inline-block manage-content">
                                    <a href="{{ route('agent.frontend.sections',$k) }}" target="_blank" class="btn btn-outline-light text-center text-white cog-btn"  data-toggle="tooltip" data-original-title="@lang('Manage Content')">
...
<a href="{{route('agent.frontend.manage.pages')}}"  class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-backward"></i> @lang('Go Back') </a>
@endpush
